// TithiToday - Festival Data 2025
// Site Name: TithiToday
// Clean data - NO Vara, NO Nakshatra
...
console.log('🪔 TithiToday Data Loaded');
console.log(`✅ ${Object.keys(panchangData).length} festivals for 2025`);
