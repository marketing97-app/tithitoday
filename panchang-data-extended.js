// TithiToday - Complete Panchang Data (2025-2030)
// Auto-generated 5-year festival database
// Total: 259 festivals
...
console.log('📅 Panchang Data Loaded');
console.log(`✅ ${Object.keys(panchangData).length} festivals available`);
console.log(`📊 Years: ${getAvailableYears().join(', ')}`);
